...
def train_bcq(params):
    ...
    # 初始化 BCQ 代理
    policy = BCQ(state_dim, action_dim, max_action, device, 3e-4, 32, 32, 32,
                 params.get("discount"), params.get("tau"), params.get("lambda"), params.get("phi"))
